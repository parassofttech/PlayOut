...
function MultiplayerGames() {
  return (
    <div className="min-h-screen bg-[#050816] overflow-hidden">
      {/* Background Effects */}
      <div className="fixed top-0 left-0 w-96 h-96 bg-pink-500/10 blur-3xl rounded-full" />
      <div className="fixed bottom-0 right-0 w-96 h-96 bg-violet-500/10 blur-3xl rounded-full" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto mt-6 text-gray-400 text-sm md:text-lg">
            Challenge your friends, compete against AI and enjoy exciting
            multiplayer experiences with fun and competitive gameplay.
          </p>
        </div>

        {/* Featured Banner */}
        <div className="relative overflow-hidden rounded-[30px] border border-white/10 mb-16 group">
          <img
          ...
          <div className="absolute left-5 md:left-10 bottom-5 md:bottom-10 max-w-xl">
            <div className="flex flex-wrap gap-3 mb-4">
              ...
              <span className="px-4 py-2 rounded-full bg-pink-500 text-white text-sm font-bold">
                #1 Multiplayer
              </span>
            </div>
            ...
            <p className="text-gray-300 mt-4 text-sm md:text-base">
              Challenge your friends or battle against AI in the ultimate
              strategy showdown.
            </p>
        ...
        <div className="mt-20 rounded-[35px] border border-white/10 bg-linear-to-r from-pink-500/10 via-violet-500/10 to-purple-500/10 backdrop-blur-xl">
          <div className="p-10 md:p-14 text-center">
            ...
            <p className="mt-4 text-gray-400 max-w-2xl mx-auto">
              Compete against real players, improve your skills and become the
